...
config.read('%s/configs/prod.config' % (PROJECT_DIR))
...
ADMINS_TO_ACCESS_REPORTS = ['suman@atai.ai','srinivas.mallipudi@soctronics.com', 'PrabhakaraRao.Aravapalli@invecas.com','kp@soctronics.com','bhavana@atai.ai']
SUB_ADMINS_TO_ACCESS_REPORTS = ['trinath@atai.ai']
STAGED_EMPLOYEE_INFO_EMAILS=['suman@atai.ai','dipak@atai.ai','bhavana@atai.ai']
MIS_REPORT_RECEIVER_EMAILS =['suman@atai.ai','srinivas.mallipudi@soctronics.com', 'PrabhakaraRao.Aravapalli@invecas.com','kp@soctronics.com','bhavana@atai.ai']
CLB_REPORT_RECEIVER_EMAILS =['suman@atai.ai',]
IGNOROR_PUNCH_DEVICES = ['AIOR181160597', 'AIOR181160618']
IGNOROR_PUNCH_SOURCES = ['HONEYPUNCH_B1_LT_ROOM_D1_TK', 'HONEYPUNCH_B1_LT_ROOM_D2_TK', 'HONEYPUNCH_B1_UPS_ROOM_TK', 'HONEYPUNCH_BOOM_BARRIER_EXIT_BIKE_TK', 'HONEYPUNCH_BOOM_BARRIER_BIKE_IN_TK', 'HONEYPUNCH_BOOM_BARRIER_EXIT_CAR_TK', 'HONEYPUNCH_BOOM_BARRIER_CAR_IN_TK', 'HONEYPUNCH_LIFT01_READER', 'HONEYPUNCH_LIFT04_READER', 'HONEYPUNCH_S1_BMS_ROOM_TK', 'HONEYPUNCH_S1_EMERGENCY_EXIT_TK', 'HONEYPUNCH_S1_FIRE_LIFT_TK', 'HONEYPUNCH_S1_LIFT_LOBBY_TK', 'HONEYPUNCH_S1_MAIN_ENTRANCE_TK', 'HONEYPUNCH_S1_PARKING_EXIT_TK', 'HONEYPUNCH_S1_SERVICE_LIFT_TK', 'HONEYPUNCH_S2_EMERGENCY_EXIT_TK', 'HONEYPUNCH_S2_FIRE_LIFT_TK', 'HONEYPUNCH_S2_MAIN_ENTRANCE_TK', 'HONEYPUNCH_S2_SERVICE_LIFT_TK','HONEYPUNCH_TER_EMERGENCY_EXIT_TK','HONEYPUNCH_TER_FIRE_LIFT_TK','HONEYPUNCH_TER_MAIN_ENTRANCE_TK','HONEYPUNCH_TER_SERVICE_LIFT_TK','HONEYPUNCH_12F_AI_INTERCONNECT_TK', 
'HONEYPUNCH_12F_FIN_ENTRANCE_TK', 'HONEYPUNCH_12F_CMD_ENTRANCE_TK', 'HONEYPUNCH_12F_FIN_INTERCONNECT_TK', 'HONEYPUNCH_12F_EMERGENCY_EXIT', 'HONEYPUNCH_12F_FIRE_LIFT_TK', 'HONEYPUNCH_12F_HUB_ROOM_TK', 'HONEYPUNCH_12F_SERVICE_LIFT_TK']